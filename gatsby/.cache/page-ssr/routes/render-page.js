...
// EXTERNAL MODULE: external "/home/nero/workspace/projects/pashtelka-faion-net/gatsby/node_modules/react/index.js"
...
var _react = _interopRequireDefault(__webpack_require__(2006));
...
"use strict";
module.exports = require("/home/nero/workspace/projects/pashtelka-faion-net/gatsby/node_modules/react/index.js");
...
var React = _interopRequireWildcard(__webpack_require__(2006));
...
var _react = __webpack_require__(2006);
...
const React=__webpack_require__(2006);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(3304);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(9592);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
module.exports = require("/home/nero/workspace/projects/pashtelka-faion-net/gatsby/.cache/ssr-builtin-trackers/fs");
